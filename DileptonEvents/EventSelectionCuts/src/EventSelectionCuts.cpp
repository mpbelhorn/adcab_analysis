...
void EventSelectionCuts::fillDataSet(const int &component)
{ 
...
void EventSelectionCuts::fillHistograms(const int& component)
{
...
void EventSelectionCuts::drawHistograms()
{
  for (int i = 0; i < tags_.species_.size(); ++i) {
...
void EventSelectionCuts::saveHistograms(const TString& filename)
{
...
void EventSelectionCuts::generateModels()
{
...
void EventSelectionCuts::fitData(const TString& filename, const TString& data_set)
{  
...
void EventSelectionCuts::plotFitAccuracy(
...
void EventSelectionCuts::plotFitProjection(
